...
function History() {
  return (
    <div id="History" className="d-grid overflow-auto pt-2 p-lg-3" >
      {/* for 1st bid */}
      <div class="History_Bid d-flex text fw-medium rounded-5 gap-1 mb-3 px-4 py-2">
        <span>
          User1
        </span>
          ...
          <div className="modal-dialog">
            <div id="Place_Modal_Content" className="modal-content bg-danger border border-0 rounded-5">
              ...
              <div id="Place_Modal_Body" className="text-center border border-black rounded-5 bg-white fw-medium p-4 m-5">
                ...
                <div id="typeBidNumber" class="input-group align-items-center justify-content-center rounded-5 mb-3">
                  <input min="10" type="number" pattern="[0-9]*" placeholder="1000" id="typeBidNumber" class="form-control text text-end boarder border-0 shadow-none rounded-5 py-2" />
...
function AuctionDetail() {
  ...
  useEffect(() => {
    // Call handleAuction
    const setEvent = 0; // Replace with your condition true or fales
    ...
    <div className="">
      ...
      <div id="AuctionDetail" className="d-flex flex-column flex-sm-row gap-1 gap-md-3">
        ...
        <div id="AuctionDetail_card" className="col card p-4">
          ...
          <div class="switch-field d-lg-flex gap-3">
